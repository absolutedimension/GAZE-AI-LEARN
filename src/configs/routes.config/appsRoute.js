...
const appsRoute = [
    ...
    //     component: React.lazy(() => import('views/project/ProjectList/components/LiveCodeContainer')),
    //     authority: [ADMIN, USER],
    //     meta: {
    //         pageContainerType: 'gutterless',
    //     },
    ...
    // },
    {
        ...
        component: React.lazy(() => import('views/crm/Mail/components/livecodeComponent/LiveCodeContainer')),
        authority: [ADMIN, USER],
        meta: {
            pageContainerType: 'gutterless',
        },
