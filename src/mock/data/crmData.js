...
export const mailData = [
        ...
        message: [
            {
                ...
                avatar: '/img/avatars/thumb-1.jpg',
                date: '12:06PM',
                content:"JavaScript is a high-level, interpreted programming language primarily used for web development. It was initially created by Brendan Eich at Netscape Communications in 1995. JavaScript was designed to add interactivity and dynamic behavior to static web pages. Over time, it has evolved and become the most widely used language for developing web applications.",
                attachment: [
                    {
                        file: 'Prospectus.doc',
                        size: '1MB',
    ...
    {
        id: 3,
        name: 'Understanding Basic concept and syntax',
        label: 'work',
        group: 'module_1',
        flagged: false,
        starred: true,
        ...
        message: [
            {
                ...
                date: 'Jan 28',
                content:
                    "Variables: Declare and store data using var, let, or const.",
                attachment: [],
           ...
           
            {
                ...
                date: 'Jan 28',
                content:
                    "Data Types: Understand primitive types (string, number, boolean, etc.) and complex types (object, function).",
                attachment: [],
            ...
            },
            {
                ...
                date: 'Jan 28',
                content:
                    "Operators: Perform operations on variables using arithmetic, assignment, comparison, and logical operators.",
                attachment: [],
            ...
            },
            {
                ...
                date: 'Jan 28',
                content:
                    "Control Flow Statements: Use if/else and loops (for, while, do...while) for conditional execution and repetition.",
                attachment: [],
