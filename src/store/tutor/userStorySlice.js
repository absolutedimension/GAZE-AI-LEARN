...
export const userStorySlice = createSlice({
    ...
    reducers: {
        ...
        messageRecievedUserStory: (state, action) => {
...
export const { sendPromptChatGPT, setCurrentTabUserStory, updateHistory, newCardAdded, extractedData, showUserStory, sendMessageToChatBox, takeTest, setNewStory, setChatFromStream, webSocketConnected, webSocketError, webSocketDisconneted, messageRecievedUserStory, messageSent } = userStorySlice.actions
